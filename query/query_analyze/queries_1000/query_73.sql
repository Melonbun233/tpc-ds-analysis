...
\o /var/lib/postgresql/data/analyze/sf_1000/analyze_73.json
EXPLAIN (FORMAT JSON, ANALYZE)
-- start query 1 in stream 73 using template query74.tpl
with year_total as (
...
-- end query 1 in stream 73 using template query74.tpl
\echo query_73 processed