...
\o /var/lib/postgresql/data/analyze/sf_1/analyze_85.json
...
select   
 ...
 order by
   lochierarchy desc,
   case when grouping(i_category)+grouping(i_class) = 0 then i_category end, -- alias not working here, modified
   rank_within_parent
 limit 100;
