...
\o /var/lib/postgresql/data/analyze/sf_1/analyze_13.json
     ...
     FROM item,
         (SELECT iss.i_brand_id brand_id ,
          ...
          WHERE ss_item_sk = iss.i_item_sk
              ...
              AND d1.d_year BETWEEN 2000 AND 2000 + 2 INTERSECT
              ...
              AND d2.d_year BETWEEN 2000 AND 2000 + 2 INTERSECT
     ...
     FROM
         (SELECT ss_quantity quantity ,
          ...
          WHERE ss_sold_date_sk = d_date_sk
              ...
              FROM catalog_sales ,
                   date_dim WHERE cs_sold_date_sk = d_date_sk
              AND d_year BETWEEN 2000 AND 2000 + 2
              UNION ALL
              SELECT ws_quantity quantity ,
                     ws_list_price list_price
              FROM web_sales ,
                   date_dim WHERE ws_sold_date_sk = d_date_sk
