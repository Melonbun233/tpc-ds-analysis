...
\o /var/lib/postgresql/data/explain/sf_1000/explain_65.json
EXPLAIN (FORMAT JSON)
-- start query 1 in stream 65 using template query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
-- end query 1 in stream 65 using template query66.tpl
\echo query_65 processed